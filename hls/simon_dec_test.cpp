...
int main()
{
    ...
    simon32s64_decrypt( gold_cyphertxt0 , gold_cyphertxt1, gold_key, &test_plaintxt0 , &test_plaintxt1);
   
    if (gold_plaintxt0 != test_plaintxt0 || gold_plaintxt1 != test_plaintxt1) {
        fprintf(stdout, "*******************************************\n");
        fprintf(stdout, "FAIL: Output DOES NOT match the golden output\n");
        fprintf(stdout, "Test Pt %d: %04x, %04x\n", j, test_plaintxt0, test_plaintxt1);
        fprintf(stdout, "Gold Pt %d: %04x, %04x\n", j, gold_plaintxt0, gold_plaintxt1);
        fprintf(stdout, "*******************************************\n");
        return 1;
    } else {
        fprintf(stdout, "*******************************************\n");
    ...
    WORD64 test_plaintxt0_64;
    WORD64 test_plaintxt1_64;
    ...
    simon128s256_decrypt( gold_cyphertxt0_64 , gold_cyphertxt1_64, gold_key_64, &test_plaintxt0_64 , &test_plaintxt1_64);
   
    if (gold_plaintxt0_64 != test_plaintxt0_64 || gold_plaintxt1_64 != test_plaintxt1_64) {
        fprintf(stdout, "*******************************************\n");
        fprintf(stdout, "FAIL: Output DOES NOT match the golden output\n");
        fprintf(stdout, "Test Pt %d: %04x, %04x\n", j, test_plaintxt0_64, test_plaintxt1_64);
        fprintf(stdout, "Gold Pt %d: %04x, %04x\n", j, gold_plaintxt0_64, gold_plaintxt1_64);
        fprintf(stdout, "*******************************************\n");
        return 1;
    } else {
        fprintf(stdout, "*******************************************\n");
